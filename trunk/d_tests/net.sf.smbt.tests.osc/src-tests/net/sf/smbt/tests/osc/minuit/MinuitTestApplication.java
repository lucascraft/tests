...
public class MinuitTestApplication implements IApplication {
	private MinuitOscJob job;

	@Override
	public Object start(IApplicationContext context) throws Exception {
		XQZTestsUtils.initMd8OscPortOutTestWorkspace();
