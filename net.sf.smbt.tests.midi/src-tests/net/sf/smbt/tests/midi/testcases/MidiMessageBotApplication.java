...
package net.sf.smbt.tests.midi.testcases;
...
import net.sf.smbt.tests.utils.SysexMessagesBotJob;
...
public class MidiMessageBotApplication implements IApplication {
	private SysexMessagesBotJob job;

	@Override
	public Object start(IApplicationContext context) throws Exception {
		XQZTestsUtils.initMidiPortOutTestWorkspace();
		...
		job = new SysexMessagesBotJob();
		job.schedule();
		
		while (job.isRunning()) // Just waiting ... zzzZZzZZzZZzz
			;
		return null;
	}
