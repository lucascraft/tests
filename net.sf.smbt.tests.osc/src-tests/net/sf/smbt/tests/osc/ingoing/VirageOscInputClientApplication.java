...
public class VirageOscInputClientApplication implements IApplication {
	private AbstractTTLJob job;
	@Override
	public Object start(IApplicationContext context) throws Exception {
		XQZTestsUtils.initVirageOscInputTestWorkspace();
